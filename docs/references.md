...
* [How to write a simple operating system by Mike Saunders](http://mikeos.sourceforge.net/write-your-own-os.html)
* [Bare Bones Bootloader by joesavage](https://github.com/joesavage/bare-bones-bootloader)
* [Bran's Kernel Development A tutorial on writing kernels](http://www.osdever.net/bkerndev/Docs/title.htm)
* [Operating Systems Development - Graphics 1](http://www.brokenthorn.com/Resources/OSDevVga.html)

## Assembly Language References
* [x86 Assembly Wikibook](https://en.m.wikibooks.org/wiki/X86_Assembly)
